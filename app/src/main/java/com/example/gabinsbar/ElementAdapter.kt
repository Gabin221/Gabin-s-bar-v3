...
class ElementAdapter(private val elements: List<Element>, private val onItemClick: (Element) -> Unit) :
    ...
    class ElementViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        val calories: TextView = view.findViewById(R.id.elementCalories)
    }
    ...
    override fun onBindViewHolder(holder: ElementViewHolder, position: Int) {
        ...
        holder.calories.text = element.extraInfo
