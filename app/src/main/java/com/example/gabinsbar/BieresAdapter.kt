...
class BieresAdapter(private val elements: List<Element>, private val onItemClick: (Element) -> Unit) :
    RecyclerView.Adapter<BieresAdapter.BieresViewHolder>() {

    class BieresViewHolder(view: View) : RecyclerView.ViewHolder(view) {
